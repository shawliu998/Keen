...
function viewerError(error: unknown): string {
  ...
  if (error instanceof LearningCoreDocumentContentError) {
    ...
    if (error.reason === "too_large") return "This PDF is larger than the 32 MiB viewer limit. The citation excerpt remains available below.";
  ...
  return "Keen could not safely render this PDF page. The citation excerpt remains available below.";
}
