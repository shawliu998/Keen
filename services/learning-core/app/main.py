...
from .routers.autonomous_study_sessions import (
    router as autonomous_study_sessions_router,
)
from .routers.conversations import router as conversations_router
from .routers.focused_study_requests import router as focused_study_requests_router
from .routers.learning_interventions import router as learning_interventions_router
from .routers.providers import router as providers_router
from .routers.reviews import router as reviews_router
from .routers.study_plan_proposals import router as study_plan_proposals_router
...
from .services.conversation_answers import ConversationAnswerRuntime
...
def create_app(
    ...
    *,
    ...
    async def lifespan(app: FastAPI) -> AsyncIterator[None]:
        with hold_database_instance_lock(settings.database_path) as lock_path:
            ...
            with app.state.database.connection() as connection:
                interrupted_messages = ConversationRepository(
                    connection
            ...
            logger.info(
                ...
                extra={
                    ...
                    "interrupted_conversation_messages_recovered": len(
            ...
            try:
                ...
                with app.state.database.connection() as connection:
                    ConversationRepository(connection).recover_interrupted_messages()
    ...
    app.state.conversation_answer_runtime = ConversationAnswerRuntime()
    ...
    app.include_router(autonomous_study_sessions_router)
    app.include_router(focused_study_requests_router)
    app.include_router(learning_interventions_router)
    app.include_router(conversations_router)
    app.include_router(reviews_router)
    app.include_router(providers_router)
    app.include_router(study_plan_proposals_router)
