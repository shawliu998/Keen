...
class ReviewRepository:
        ...
        with write_scope(self.connection, commit=commit):
            ...
            self.connection.execute(
                ...
                INSERT INTO review_attempts (
                    id, review_item_id, originating_task_id, rating, response_json,
    ...
    def get_attempt_by_idempotency_key(self, key: str) -> dict[str, Any] | None:
        """Restore a prior review write before recalculating its FSRS result."""
        return self._attempt_by_idempotency_key(key)
