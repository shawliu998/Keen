...
| Deep Learn | Live Start/Resume renders a persisted plan, opening diagnostic and one persisted Active Recall cloze. Pending/unresolved recall hides lesson/session/source clues before paint; answer records deterministic mastery evidence once. Browser Demo remains explicitly sample-only and makes zero requests. | editable plan, teaching, additional checkpoint/item types, practice, summary, Review/FSRS handoff, broader persisted progress/pause/resume/recovery and all service/provider failures |
